const Map<String, String> wordList = {
  ...
  'Sustentável': 'Capaz de ser mantido ou conservado a longo prazo, sem esgotar os recursos naturais ou causar danos ambientais significativos.',
  ...
  'Conservação': 'Proteção e gerenciamento dos recursos naturais para prevenir sua degradação, assegurar sua sustentabilidade e preservar a biodiversidade.',
};
